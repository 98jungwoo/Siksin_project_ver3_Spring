									...
									<div class="tab">
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												...
												<!-- 버튼2 -->
												<h3 class="cursive-font">Review</h3>
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block"
															onclick="location.href='./SiksinReviewSelect'"
															value="리뷰 전체보기">
													</div>
												</div>
												<!-- 버튼3 -->
													...
													<c:choose>
														<c:when test="${empty sessionScope.phoneNum}">
															...
															<div class="row form-group">
																<div class="col-md-12">
																	<input type="submit" class="btn btn-primary btn-block"
																		onclick="location.href='./SiksinLogin'" value="로그인">
																</div>
															</div>
														</c:when>
														<c:otherwise>
															...
															<div class="row form-group">
																<div class="col-md-12">
																	<input type="submit" class="btn btn-primary btn-block"
																		onclick="location.href='./SiksinLogout'" value="로그아웃">
																</div>
															</div>
														</c:otherwise>
													</c:choose>
