						...
						<ul>
							<c:choose>
								<c:when test="${empty sessionScope.phoneNum}">
									<li class="btn-cta"><a
										onclick="location.href='./LoginView.do'"><span>Login</span></a>
								</c:when>
								<c:otherwise>
									<li class="btn-cta">
									<li class="has-dropdown"><a href="./SiksinSelect.do">회원관리</a>
										<a
										href="./SiksinSelectDetail.do?memberName=${sessionScope.memberName}">${sessionScope.memberName}
											님</a>
									<li class="btn-cta"><a
										onclick="location.href='./Logout.do'"><span>Logout</span></a>
								</c:otherwise>
							</c:choose>
						</ul>
					</div>
					...
					<div class="col-md-12 col-md-offset-0 text-left">
						<div class="row row-mt-15em">
							<div class="col-md-7 mt-text animate-box"
								...
								<span class="intro-text-small"> <a href="index.html"
									target="_blank">대한민국 No.1 맛집 서비스</a></span>
											...
											<form method="post" name="login" id="login"
												...
												<div class="tab-content-inner active" data-content="signup">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<label for="phoneNumArea">PhoneNumber</label> <select
																name="phoneNumArea" id="phoneNumArea"
																class="form-control">
																...
																<!-- 전호번호 로그인 -->
															</select> <input type="text" id="phoneNum" name="phoneNum"
																class="form-control">
														</div>
													</div>
												</div>
												...
												<div class="row form-group">
													<ul>
														...
														<li><a
															onclick="location.href='./SiksinSearchPassword'">비밀번호
																찾기&nbsp;</a> <a
															onclick="location.href='./SiksinMemberInsert'">|&nbsp;&nbsp;회원가입
																하기</a></li>
													</ul>
												</div>
												<div class="row form-group">
