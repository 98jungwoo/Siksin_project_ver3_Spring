...
<title>SIKSIN &mdash;review_select_detail</title>
						...
						<div class="row row-mt-15em">
							<div class="col-md-12 mt-text animate-box"
								...
								<span class="intro-text-small"> <a href="#"
									target="_blank">대한민국 No.1 맛집 서비스 siksin. 리뷰 내용 확인</a></span>
								...
								<fieldset name="review">
									...
									<form method="post" enctype="application/x-www-form-urlencoded">
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label class="member_label" for="ratingScore">별점<em>*</em></label>
												<input type="text" id="ratingScore" name="ratingScore"
													class="form-control" value="${siksinReviewDTO.ratingScore}"
													readonly>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label for="reviewContent">리뷰 작성<em>*</em></label>
												<textarea name="reviewContent" id="reviewContent" cols="30"
													rows="10" class="form-control" readonly="readonly">${siksinReviewDTO.reviewContent}</textarea>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label class="member_label" for="restaurantTag">매장
													태그</label> <input type="text" id="restaurantTag"
													name="restaurantTag" class="form-control"
													value="${siksinReviewDTO.restaurantTag}" readonly>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label for="restaurantName">매장 명(필수)</label> <input
													type="text" id="restaurantName" name="restaurantName"
													class="form-control"
													value="${siksinReviewDTO.restaurantName}" readonly>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label for="restaurantArea">매장 지역</label> <input type="text"
													id="restaurantArea" name="restaurantArea"
													class="form-control"
													value="${siksinReviewDTO.restaurantArea}" readonly>
											</div>
										</div>

										<!-- 닉네임 설정 로그인 했을때 닉네임으로 보이게하고픔,,, -->
										<div class="row form-group">
											<div class="col-md-5">
												<label for="reviewNickName">닉네임</label> <input
													type="text" id="reviewNickName" name="reviewNickName"
													class="form-control"
													value="${siksinReviewDTO.reviewNickName}" readonly>
											</div>
											...
											<div class="form-group">
												<div class="member_button">
													<button type="button" class="btn btn-primary"
														id="review_submit"
														onclick="location.href='./SiksinReviewUpdate?reviewNum=${siksinReviewDTO.reviewNum}'">
														<i class="fas fa-user-edit mr-sm-1"></i>리뷰 수정
													</button>
													<button type="button" class="btn btn-primary"
														id="review_submit"
														onclick="location.href='./SiksinReviewDelete?reviewNum=${siksinReviewDTO.reviewNum}'">
														<i class="fas fa-user-edit mr-sm-1"></i>리뷰 삭제
													</button>
												</div>
											</div>
										</div>
