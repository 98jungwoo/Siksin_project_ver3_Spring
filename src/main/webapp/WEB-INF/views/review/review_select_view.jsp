...
<title>SIKSIN &mdash;review_select</title>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="card">
											<!-- 여기 표생성 -->
											<div
												class="col-md-20 col-md text-center gtco-heading animate-box">
												<!-- <div id="tablestyle">표 길이 변경하려고 만든 거임 -->
												<h2 class="cursive-font_sec">리뷰목록</h2>
												<!-- /react-text -->
												<span data-reactid="1085">고객님들이 직접 작성하신 따끈한 후기와 평가를
													들어보세요.</span>
												<div class="row">
													<div>
														<div class="col-md-12">
															<div class="card">
																<div class="card-header">
																	<p align="right">리뷰: ${listcount} 개</p>
																	<h3 class="title01" data-reactid="1083"></h3>
																	<br>
																</div>
																<!-- 표 시작-->
																<div class="member_select_background">
																	<table class="table table-hover mx-auto">
																		<thead class="thead-light">
																			<tr class="text-center">
																				...
																				<th style="text-align: center">음식점 명(지역)</th>
																		...
																		<c:forEach var="list" items="${list}">
																			<tbody>
																				<!-- 박스를 누르면 바로 셀렉트디테일로 이동 -->
																				<tr class="text-center"
																					onclick="location.href='./SiksinReviewSelectDetail?reviewNum=${list.reviewNum}'">
																					<!-- 번호 -->
																					<td>${list.reviewNum}</td>
																					<!-- 음식점 명 및 지역 -->
																					<td>${list.restaurantName}(${list.restaurantArea})</td>
																					<!-- 별점-->
																					<td>${list.ratingScore}</td>
																					<!-- 리뷰내용-->
																					<td>${list.reviewContent}</td>
																					<!-- 작성자 -->
																					<td>${list.reviewNickName}</td>
																					<!-- 작성일 -->
																					<td>${list.writeday}</td>
																				</tr>
																			</tbody>
																	...
																	<table class="table table-hover">
																		...
																		<c:if test="${empty list}">
																			<tr>
																				<td colspan="4"></td>
																				<td class="text-center">입력된 리뷰가 없습니다.</td>
																			</tr>
																		</c:if>
																		<tr></tr>
																	</table>
																	<nav class="navbar justify-content-end">
																		<div class="btn-group">
																			<button type="button"
																				...
																				onclick="location.href='./SiksinReviewInsert'">
																				<i class="fas fa-user-edit mr-sm-1"></i>리뷰등록
																			</button>
																		</div>
																	</nav>
																</div>
