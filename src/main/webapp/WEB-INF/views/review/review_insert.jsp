...
<title>SIKSIN &mdash;review_insert</title>
						...
						<div class="row row-mt-15em">
							<div class="col-md-12 mt-text animate-box"
								...
								<span class="intro-text-small"> <a href="#"
									target="_blank">대한민국 No.1 맛집 서비스 siksin. 리뷰작성</a></span>
							...
							<div class="col-md-12 animate-box">
								<fieldset name="review">
									...
									<form method="post" enctype="application/x-www-form-urlencoded"
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label class="sr-only" for="reviewContent">리뷰 작성<em>*</em></label>
												<textarea name="reviewContent" id="reviewContent" cols="30"
													rows="10" class="form-control"
													placeholder="매장에 대한 리뷰를 작성해보세요*"></textarea>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label class="member_label" for="restaurantTag">매장
													태그</label> <select name="restaurantTag" id="restaurantTag"
													class="form-control">
										...
										<div class="row form-group">
											<div class="col-md-12">
												...
												<input name="restaurantName" id="restaurantName"
													class="form-control" placeholder="매장 명*"></input>
											</div>
										</div>
										...
										<div class="row form-group">
											<div class="col-md-12">
												<label class="sr-only" for="restaurantArea">매장 지역</label> <input
													...
													class="form-control" placeholder="매장 지역"></input>
											</div>
										</div>
										...
										<div class="row form-group">
											<!-- 리뷰 수정을 위한 비밀번호 입력 -->
											<div class="col-md-7">
												<label class="sr-only" for="reviewPassword">비밀번호(필수)</label>
												<input type="password" name="reviewPassword"
													id="reviewPassword" class="form-control"
													placeholder="리뷰수정을 위한 비밀번호(필수)"></input>
											</div>
											<div class="col-md-5">
												<label class="sr-only" for="reviewNickName">닉네임</label> <input
													type="hidden" name="reviewNickName" id="reviewNickName"
													class="form-control" value="${sessionScope.nickName}"></input>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="member_button">
												<input type="submit" class="btn btn-primary"
													id="review_submit" value="리뷰 작성완료"> <input
