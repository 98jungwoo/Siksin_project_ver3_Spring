...
<title>SIKSIN &mdash;member_selec_detail</title>
...
<script type="text/javascript">
	function memberDelete() {
		if (confirm("${siksinMemberDTO.memberName}님 회원을 탈퇴 하시겠습니까?")) {
			location.href = "./SiksinMemberDelete?memberNum=${siksinMemberDTO.memberNum}"
		}
	}
				...
				<div class="row" id="member#ffffff">
					<div class="col-md-12">
						<fieldset name="member" class="member">
							...
							<form action="./SiksinSelectDetail" method="post"
								enctype="application/x-www-form-urlencoded">
								<hr>
								<div class="row form-group">
									<div class="col-md-12" id="id" style="display: none;">
										<label class="member_label" for="memberName">번호<em>*</em></label>
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<c:choose>
											<c:when test="${siksinDTO.gender == '여자'}">
												<input type="text" class="form-control" name="여자" id="여자"
													value="${siksinMemberDTO.gender}" readonly>
											</c:when>
											<c:otherwise>
												<input type="text" class="form-control" name="남자" id="남자"
													value="${siksinMemberDTO.gender}" readonly>
											</c:otherwise>
										</c:choose>
									</div>
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="memberArea">사는지역</label> <input
											type="text" name="memberArea" id="memberArea"
											class="form-control" value="${siksinMemberDTO.memberArea}"
											readonly>
									</div>
								</div>
								<hr>
								<div class="form-group">
									<div class="member_button">
										<nav class="navbar justify-content-end">
											...
											<div class="btn-group">
												<button type="button" class="btn btn-outline-info mr-sm-1"
													onclick="location.href='./SiksinMemberSelect'">
