								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input class="form-control" type="password" name="password"
											id="password" placeholder="비민번호를 입력해주세요">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<label class="member_label" for="gender">성별</label><br> <input
											...
											value="여자"> 여자 <input class="member_label"
											type="radio" name="gender" id="gender" value="남자"
											checked="checked"> 남자
									</div>
								</div>
								...
								<div class="checkbox_group">
									...
									<div class="checkbox">
										<input type="checkbox" name="agree" id="agree1" value="이용약관동의"
											class="nomal" checked>[필수] 이용약관 동의<em>*</em> <br>
										<input type="checkbox" name="agree" id="agree2"
											value="개인정보수집동의" class="nomal" checked>[필수] 개인정보 수집 및
										이용에 동의<em>*</em><br> <input type="checkbox" name="agree"
											id="agree3" value="만14세 이상" class="nomal" checked>[필수]
										만 14세 이상<em>*</em> <br> <input type="checkbox"
											name="agree" id="agree4" value="위치기반동의" class="nomal" checked>[선택]
										위치기반 서비스 이용약관에 동의<br> <input type="checkbox" name="agree"
											id="agree5" value="마케팅동의" class="nomal" checked>[선택]
								...
								<div class="form-group">
									<div class="member_button">
										<input type="submit" class="btn btn-primary" id="submitButton"
											...
											class="btn btn-primary" id="reset" value="취소하기">
									</div>
								</div>
							</form>
						</fieldset>
